...
public class DyedBackpacks extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        ItemGroup itemGroup = new ItemGroup(new NamespacedKey(this, "dyed_backpacks"), new CustomItemStack(PlayerHead.getItemStack(PlayerSkin.fromHashCode(BackpackColor.RED.getTexture())), "&4染色背包"), 2);
